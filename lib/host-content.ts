...
export const hostContentMap: Record<string, SpokeContent> = {
  ...
  "v0-export": {
    ...
    body: [
      ...
      "All of this works on {{pricing}}. Pro adds custom domains and password protection, both worth it when the URL goes to a client. When a v0 build is the centrepiece of a pitch, you can {{use-case-deck}} and hand it over as the working demo. The dashboard handles {{host-hub}} alongside the v0 demo. Project bundles work directly too. Just {{host-zip}} and the archive sits at its own link.",
    ],
    faqs: [
      {
