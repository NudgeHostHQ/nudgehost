...
export const hostContentMap: Record<string, SpokeContent> = {
  ...
  txt: {
    ...
    body: [
      ...
      "The free plan covers ten active text files at 25MB each, enough for a full novel manuscript with margin to spare. Server logs and chat exports are the most common things that push past it; for those, {{pricing|upgrade to Pro}}, or trim the file first. The same dashboard lets you {{host-hub}} alongside the text.",
    ],
    faqs: [
      {
