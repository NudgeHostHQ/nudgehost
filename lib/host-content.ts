...
export const hostContentMap: Record<string, SpokeContent> = {
  ...
  html: {
    ...
    body: [
      "Sometimes you just need to put an HTML file on the internet. Maybe it's a prototype you want to show a client, a single-page landing page for a side project, or an HTML output you just generated from an AI tool and want to share with a friend. You don't need a server. You don't need Vercel. You need a URL.",
  ...
  "claude-artifact": {
    ...
    body: [
      "Claude's artifacts feature is one of the most useful additions to chat AI in years — you can ask for a dashboard, a calculator, a landing page, a game, and get a working HTML/JS thing right there in the conversation. The catch: those artifacts live inside Claude. You can't easily send one to a friend, drop one into a Slack channel, or share one on Twitter without screenshotting it.",
  ...
  resume: {
    ...
    body: [
      ...
      "Your link is clean: nudgehost.com/your-name. It opens in the recruiter's browser instantly — no download, no Dropbox login, no 'this file may be unsafe' warning that scares people off. If you're applying for design or front-end roles, a resume is rarely enough on its own; the natural next step is to {{host-portfolio}} and {{use-case-recruiter}} as a single link.",
