...
export const devToolsContentMap: Record<string, SpokeContent> = {
  "json-formatter": {
    ...
    body: [
      ...
      "Every dev tool here is free and runs in your browser. The paid side of NudgeHost is hosting and sharing, not the tools, and you can {{home}} whenever a formatted file needs to go to someone.",
    ],
    faqs: [
      {
  ...
  base64: {
    ...
    body: [
      ...
      "Free, browser-only, nothing logged. Hosting is free to start as well; {{home}} whenever you need a link.",
    ],
    faqs: [
      {
  ...
  "url-encoder": {
    ...
    body: [
      ...
      "Free and browser-based, and when the page behind the URL needs hosting you can {{home}}.",
    ],
    faqs: [
      {
  ...
  "jwt-decoder": {
    ...
    body: [
      ...
      "A JWT is Base64 under the hood, so when you're decoding something that isn't a token you can {{dev-base64}} more generally. The payload is JSON, and once decoded you can {{dev-json-formatter}} to pretty-print a dense response.",
      ...
      "The decoder runs locally and logs nothing, which matters because tokens are sensitive. When something does need hosting, you can {{home}} with nothing to set up.",
    ],
    faqs: [
      {
