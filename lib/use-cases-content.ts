...
export const useCasesContentMap: Record<string, SpokeContent> = {
  "share-resume-as-link": {
    ...
    keyPoints: [
      ...
      "Open tracking is private to you — the recruiter sees a normal link, you see when they viewed it.",
    ],
  ...
  "send-portfolio-to-recruiter": {
    ...
    title: "How to send your portfolio to a recruiter — one clean link",
    description:
    ...
    keyPoints: [
      ...
      "Recruiters open your work directly in their browser — no account, no download.",
